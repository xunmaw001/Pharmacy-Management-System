	...
	<view class="content my-publish-pv">
		<form>
			<view class="cu-form-group">
				...
				<input :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0 0 0 20rpx","borderColor":"rgba(191, 170, 142, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","textAlign":"left","borderRadius":"20rpx 0 20rpx 0","borderWidth":"2rpx","width":"95%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' disabled="true" v-model="ruleForm.username" placeholder="留言人用户名"></input>
			</view>
			<view class="cu-form-group">
				<!-- <view :style="userInfoForm.list.title" class="title">留言内容</view> -->
				<textarea :style='{"padding":"0 20rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0 20rpx","borderColor":"rgba(191, 170, 142, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","borderRadius":"20rpx 0 20rpx 0","borderWidth":"2rpx","width":"95%","fontSize":"28rpx","borderStyle":"solid","height":"300rpx"}' v-model="ruleForm.content" placeholder="留言内容"></textarea>
			</view>
			...
			<view class="cu-form-group" style="text-align:center">
				<button :style='{"padding":"0 20rpx","boxShadow":"0 0 0px rgba(0,0,0,0) inset","margin":"20rpx 0","borderColor":"rgba(64, 158, 255, 0)","backgroundColor":"rgba(191, 170, 142, 1)","color":"#fff","borderRadius":"20rpx 0 20rpx 0","borderWidth":"1","width":"55%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</template>
